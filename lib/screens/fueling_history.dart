...
class FuelingHistory extends StatefulWidget {
  @override
  _FuelingHistoryState createState() => _FuelingHistoryState();
}

class _FuelingHistoryState extends State<FuelingHistory> with SingleTickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text("Fueling History",style: TextStyle(
