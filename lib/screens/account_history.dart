...
class _AccountHistoryState extends State<AccountHistory> with SingleTickerProviderStateMixin{
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text("Account History",style: TextStyle(
        ...
        children: <Widget>[
          Container(
            ...
            child: Column(
              children: <Widget>[
                SizedBox(height: 40),
                SvgPicture.asset("assets/moneybig.svg",
                  width: 50,
                  color: Colors.white,),
                SizedBox(height: 30),
                Text("Total Spending",
